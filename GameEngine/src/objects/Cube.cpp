...
void Cube::Initalize()
{
	vertices = {
		...
		Vertex {glm::vec3(-0.5f,0.5f,-0.5f), glm::vec2(0.0f,0.0f), glm::vec3(0.0,1.0f,0.0f)},
		Vertex {glm::vec3(0.5f,0.5f,-0.5f), glm::vec2(1.0f,0.0f), glm::vec3(0.0,1.0f,0.0f)},
		Vertex {glm::vec3(0.5f,0.5f,0.5f), glm::vec2(1.0f,1.0f), glm::vec3(0.0,1.0f,0.0f)},
		Vertex {glm::vec3(-0.5f,0.5f,0.5f), glm::vec2(0.0f,1.0f), glm::vec3(0.0,1.0f,0.0f)}
	};
	indices = {
		// Back face
		0, 1, 2,
